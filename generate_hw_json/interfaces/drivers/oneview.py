    ...
    def _get_server_hardware_by_template(self, servers, template):
        ...
        for server in servers:
            ...
            if serverProfileUri:
                ...
                profileTemplate = self.client.server_profile_templates.get(
                ...
                if profileTemplate["name"] == template:
                    ...
                    filteredServers.append(
                        {"mac_address": boot_interface, "iloIPV4": iloIPV4}
                    )
            ...
            if serverProfileUri:
                ...
                for interface in templateInfo["connections"]:
                    if interface["boot"]["priority"] == "Primary":
                        boot_interface = interface["mac"]
                        break
                serversList.append({"mac_address": boot_interface, "iloIPV4": iloIPV4})
        return serversList
